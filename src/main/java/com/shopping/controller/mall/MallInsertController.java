...
public class MallInsertController extends SuperClass{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if(super.loginfo == null) {//로그인 정보 없으면 로그인 페이지로 보내버림.
			super.youNeededLogin();

			return ;
		}
		
		int stock = Integer.parseInt(request.getParameter("stock"));//재고수량
		int qty = Integer.parseInt(request.getParameter("qty"));//구매할 재고 수량
