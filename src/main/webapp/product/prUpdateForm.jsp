...
<head>
	...
	<title>Insert title here</title>
  	<style type="text/css">
  		...
  		#productPnum1{display: none; visibility: hidden;}
  	</style>
  	<script type="text/javascript">
  		$(document).ready(function(){ 
  	  		/* $('#inputdate').datepicker({dateFormat: "yy/mm/dd"}) */; //오류
	...
	<div class="container">
		...
		<input type="hidden" name="command" value="prUpdate">
			<div class="input-group" id="productPnum">
				...
				<input class="form-control" type="number" id="fakepnum" name="fakepnum" value="${requestScope.bean.num}" disabled="disabled">
				<input type="text" id="pnum" name="pnum" value="${requestScope.bean.num}">			
			</div>
			...
			<div class="input-group">
				...
				<input type="text" name="deleteImage01" value="${requestScope.bean.image03}">				
			</div>
			<div class="input-group">
			...
			<div class="input-group">
				...
				<input class="form-control" type="date" id="inputdate" name="inputdate" value="${requestScope.bean.inputdate}">				
			</div>
